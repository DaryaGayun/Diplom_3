...
class Urls:
    ...
    URL_PERSONAL_ACCOUNT_PAGE = f"{URL_MAIN_PAGE}account/profile"
    URL_ORDERS_HISTORY_PAGE = f"{URL_MAIN_PAGE}account/order-history"
    URL_FEED_OF_ORDERS_PAGE = f"{URL_MAIN_PAGE}feed"
